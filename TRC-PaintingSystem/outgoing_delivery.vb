...
Public Class outgoing_delivery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRC_PaintingSystem.outgoing_delivery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedoutgoing_delivery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outgoing_delivery = New outgoing_delivery()
        rpt.Site = Me.Site
        Return rpt
    End Function
